...
``` Edit the project settings file: settings.py. Add your app to the INSTALLED_APPS list (you can use 'todos' or the app config from todos/apps.py). ```
``` # ...existing code...
INSTALLED_APPS = [
    # ...existing apps...
    'todos',  # or 'todos.apps.TodosConfig'
]
# ...existing code...
```
...
`- TEMPLATES['DIRS'] in the project's settings.py`
...
- `pytest`  # prefer pytest for the standalone test suite added here
